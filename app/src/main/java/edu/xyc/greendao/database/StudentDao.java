...
public class StudentDao extends AbstractDao<Student, Long> {
    ...
    public static class Properties {
        ...
        public final static Property ForeignKey = new Property(5, Long.class, "foreignKey", false, "FOREIGN_KEY");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"STUDENT\" (" + //
                ...
                "\"FOREIGN_KEY\" INTEGER);"); // 5: foreignKey
        // Add Indexes
    ...
    protected final void bindValues(DatabaseStatement stmt, Student entity) {
        ...
        Long foreignKey = entity.getForeignKey();
        if (foreignKey != null) {
            stmt.bindLong(6, foreignKey);
        }
    }
    ...
    public Student readEntity(Cursor cursor, int offset) {
        Student entity = new Student( //
            ...
            cursor.isNull(offset + 5) ? null : cursor.getLong(offset + 5) // foreignKey
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Student entity, int offset) {
        ...
        entity.setForeignKey(cursor.isNull(offset + 5) ? null : cursor.getLong(offset + 5));
     }
    ...
    public List<Student> _queryTeacher_StudentList(Long foreignKey) {
        synchronized (this) {
            if (teacher_StudentListQuery == null) {
                QueryBuilder<Student> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.ForeignKey.eq(null));
