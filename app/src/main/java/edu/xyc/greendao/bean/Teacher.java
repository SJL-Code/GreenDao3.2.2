...
import edu.xyc.greendao.database.TeacherDao;
...
public class Teacher {
    ...
    @Generated(hash = 1744296149)
    public Teacher(Long teaId, String teaName) {
        this.teaId = teaId;
    ...
    public List<Student> getStudentList() {
        if (studentList == null) {
            ...
            List<Student> studentListNew = targetDao._queryTeacher_StudentList(teaId);
            synchronized (this) {
                if (studentList == null) {
